    ...
    <div className={cn("relative flex flex-col items-center gap-1", className)}>
      ...
      <div
        className={cn(
          ...
          sizeClassName,
          showGlow && ["shadow-lg hover:shadow-xl", rank.glowColor],
          // Animation classes
          showAnimation &&
            levelAnimations[level as keyof typeof levelAnimations],
        )}
      >
  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        <p className={cn("font-bold text-lg", rank.color)}>{rank.nameVi}</p>
