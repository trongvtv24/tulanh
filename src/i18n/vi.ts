...
export const vi: TranslationKeys = {
  ...
  profile: {
    ...
    language: "Ngôn ngữ",
    levelTip:
      "💡 Mẹo: Tăng Level để mở khóa thêm nhiều bài viết hay, tricks và khóa học độc quyền!",
  },
  ...
  auth: {
    ...
    description:
      "Tham gia hệ sinh thái để kết nối, chia sẻ công việc và thăng cấp cùng cộng đồng.",
    onlyGoogle: "Chỉ hỗ trợ đăng nhập Google",
    agreement:
      "Bằng việc tiếp tục, bạn đồng ý với Quy tắc ứng xử của chúng tôi.",
  },
