...
export default function ProfilePage() {
  ...
  if (!profile)
    return <div className="p-10 text-center">{t.errors.userNotFound}</div>;
          ...
          <div className="flex flex-col md:flex-row gap-6 items-center md:items-start text-center md:text-left">
            ...
            <div className="flex-1 space-y-2">
              ...
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                <Badge
                  variant="secondary"
                  className={`px-3 py-1 ${getRankByLevel(profile.level).color}`}
                >
              ...
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                ...
                {isAdmin && (
                  <SetLevelDialog
                    ...
                    onLevelChanged={(newLvl, newXp) =>
                      setProfile((prev) =>
                        prev ? { ...prev, level: newLvl, xp: newXp } : null,
                      )
                    }
                  />
                )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20">
            <CardContent className="pt-6">
              <p className="text-sm text-center">{t.profile.levelTip}</p>
            </CardContent>
          </Card>
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {profile.bio || t.profile.noBioAdded}
                  </p>
                </CardContent>
              </Card>
            </TabsContent>
